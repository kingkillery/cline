...
- If the user asks "what is next", "what's next", or otherwise asks for the next recommended work, consult `4-3-handoff.md` first and use it as the default source of truth for remaining risks and next steps unless a newer in-session plan explicitly supersedes it.
